...
function Dashboard() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://localhost:8081/staffsconnect/staffstatisticscurrentmonth?staffId=${token.id}`)
      .then((response) => {
    ...
    axios
      .get(`http://localhost:8081/staffsconnect/staffstatisticspreviousmonth?staffId=${token.id}`)
      .then((response) => {
